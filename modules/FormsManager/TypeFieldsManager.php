...
<div class="p-3">
    <div class="mt-3 mb-3">
        ...
        <span class="lead">
            <p>
                Modulo para administrar los tipos de datos a utilizar en formularios
            </p>
        </span>
    </div>
    <div class="mt-3 mb-4">
        <a class="btn btn-primary" href="TypeFieldsForm.php">Agregar nuevo tipo</a>
        <a class="btn btn-primary" href="FormsManager.php">Regresar a Administracion de formularios</a>
    </div>
