...
class ReglasTempoEstimadoMap implements iobject, iObjMapper{
    private $Object;
    private $ObjectTableConfig;

    //Configuracion de Tabla
    protected $idfield="idreglageneral";
    protected $tablename="t_regla_general";
    ...
    public function setObjConfiguration(){
        $this->Object= new ReglasTiempoEstimado();
