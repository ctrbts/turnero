...
class CamposFormaObjMap implements iobject, iObjMapper{
    private $Object;
    private $ObjectTableConfig;

    //Configuracion de Tabla
    protected $idfield="idcampoforma";
    protected $tablename="t_formulario_campos";
    ...
    public function setObjConfiguration(){
        $this->Object= new CamposFormaObj();
