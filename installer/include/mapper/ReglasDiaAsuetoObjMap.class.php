...
class ReglasDiaAsuetoObjMap implements iobject, iObjMapper{
    private $Object;
    private $ObjectTableConfig;

    //Configuracion de Tabla
    protected $idfield="iddiaasueto";
    protected $tablename="t_regla_diasasueto";
    ...
    public function setObjConfiguration(){
        $this->Object= new ReglasDiaAsueto();
