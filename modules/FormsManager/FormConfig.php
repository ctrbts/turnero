...
<?php  $HtmlViewsController->IncludeViews(array("HtmlTopHeader","HtmlHeader"));?>
    <title>Addminstrar Formas</title>
...
<div class="p-3">
    <div class="mt-3 mb-3">
        <span class="lead" style="font-size:42px;">
            Administraci&oacute;n de Campos de la Forma:<br/> <strong><?php echo $Forma->descripcion;?></strong>
        </span>
        <div class="mt-3 mb-3">
            <span class="lead">
                <p>Aqui puedes definir los campos que llevara la forma la cual llenara el usuario al momento de agendar una cita. </p>
            </span>
        </div>
    ...
    <div class="mt-3 mb-3">
        ...
        <a class="btn btn-primary" href="FormsManager.php"> Regresar a Adminisracion de Formas</a>&nbsp;&nbsp;&nbsp;
    </div>
    <div class="p-3">
