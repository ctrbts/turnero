...
class ProfileModuleObjMap implements iobject, iObjMapper{
    private $Object;
    private $ObjectTableConfig;

    //Configuracion de Tabla
    protected $idfield="idprofilemodule";
    protected $tablename="t_profile_module";
    ...
    public function setObjConfiguration(){
        $this->Object= new ProfileModuleObj();
