...
<div class="p-3">
    <div class="mt-3 mb-4">
        <span class="display-4">Turno Nro. <?php echo $LoadedCita->idcita; ?></span>
    </div>
    <?php
    if ($show_controls) {
    ?>
    ...
    <div>
        <p class="h5">Infromaci&oacute;n del turno</p>
    </div>
    ...
    <div class="row justify-content-center mt-4 mb-3">
        <div class="col text-right">
            <button class="btn btn-lg btn-primary text-black" type="button" onclick="openInNewTab();">Imprimir turno</button>
            <!-- <?php if ($LoadedCita->EstatusCitaObj->idestatus != EStatusCita::Cancelada) { ?>
                <button class="btn btn-lg btn-primary" type="button" id="btn_downloadical_<?php echo base64_encode($LoadedCita->idcita) ?>">Descargar turno</button>
            <?php } ?> -->
        </div>
