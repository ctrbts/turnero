...
<div class="p-3 mt-3">
    ...
    <div class="row mb-4 p-2">
        <div class="col">
            <a class="btn btn-danger btn-lg" href="deleteModule.php?idmodulo=<?php echo $_GET['idmodulo'];?>">Si Deseo Borrar</a>
        </div>
        <div class="col">
            <a class="btn btn-primary btn-lg" href="ModuleManager.php">No y Cancelar</a>
        </div>
    </div>
</div>
