...
switch ($title_month) {
    ...
    case "August":
        ...
        break;
    case "September":
        $title_month = "Septiembre";
        break;
    case "October":
        $title_month = "Octubre";
        break;
    case "November":
        $title_month = "Noviembre";
        break;
    case "December":
            ...
            <div style="text-align: center; padding-top: 15px;">
                ...
                <div class="row mt-3 mb-4">
                    <div class="col-lg text-right">
                        <button class="btn btn-danger btn-lg" style="width:180px;" type="button" name="Cancelar" onclick="cancelar(); return false;">Cancelar</button>
                    </div>
                    <div class="col-lg text-left">
                        <button class="btn btn-success btn-lg" style="width:180px;" type="button" name="GuardaCita" onclick="createcita(); return false;">Guardar</button>
                    </div>
                </div>
            </div>
        </form>
