...
if(!empty($_POST)){
    if(isset($_POST['idtiposcampo']) && isset($_POST["descripcion"]) && isset($_POST["tipo"]) && isset($_POST["html"]) ){
        $idtiposcampo=$_POST['idtiposcampo'];
        ...
        $TipoCampoObj->idtiposcampo=$idtiposcampo;
       ...
       $ADOTipoCampo->UpdateTipoCampo($TipoCampoObj);
    }
}
if(!$debug){
